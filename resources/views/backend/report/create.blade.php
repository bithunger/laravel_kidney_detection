...
@section('content')
    <div class="page-heading">
        <div class="row">
            ...
            <div class="col-sm-6 pt-4 text-right">
                    ...
                    <a href="{{ url('/') }}" class="btn bg-primary text-white"><i class="fa fa-reply"></i> Back to Dashboard</a>
    ...
    <div class="page-content fade-in-up">
        <div class="ibox rounded">
            <div class="ibox-body">
                <div id="row">
                    <form method="post" action="{{ route('report') }}" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                <div class="card">
                                    <div class="card-header bg-gradient-info text-white">
                                        <h5 class="card-title">Input New Kidney Image</h5>
                                    </div>
                                    <div class="card-body">
                                 <div class="form-group">
                                            <label for="photo">Kidney Image <strong class="text-danger">*</strong> (Recommended: Only Kidney image) </label>
                        ...
                        <div class="form-group text-center mt-3">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-plus-circle"></i> Detect
                            </button>
                        </div>
                    </form>
                </div>
